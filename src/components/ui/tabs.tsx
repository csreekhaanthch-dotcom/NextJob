...
const TabsList = React.forwardRef<typeof TabsPrimitive.List, React.ComponentPropsWithoutRef<typeof TabsPrimitive.List>>(
  ({ className, ...props }, ref) => (
    <TabsPrimitive.List
      ref={ref}
...
const TabsTrigger = React.forwardRef<typeof TabsPrimitive.Trigger, React.ComponentPropsWithoutRef<typeof TabsPrimitive.Trigger>>(
  ({ className, ...props }, ref) => (
...
const TabsContent = React.forwardRef<typeof TabsPrimitive.Content, React.ComponentPropsWithoutRef<typeof TabsPrimitive.Content>>(
  ({ className, ...props }, ref) => (
