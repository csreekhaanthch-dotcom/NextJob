...
const DialogOverlay = React.forwardRef<typeof DialogPrimitive.Overlay, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Overlay>>(
  ({ className, ...props }, ref) => (
...
const DialogContent = React.forwardRef<typeof DialogPrimitive.Content, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Content>>(
...
const DialogTitle = React.forwardRef<typeof DialogPrimitive.Title, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Title>>(
  ({ className, ...props }, ref) => (
...
const DialogDescription = React.forwardRef<typeof DialogPrimitive.Description, React.ComponentPropsWithoutRef<typeof DialogPrimitive.Description>>(
  ({ className, ...props }, ref) => (
