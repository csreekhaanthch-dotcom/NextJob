...
import { Search, Globe, Users, Clock, Building, MapPin, Sparkles, Briefcase } from 'lucide-react';
...
const HomePage: React.FC = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="backdrop-blur-lg bg-white/30 p-6 rounded-2xl shadow-lg border border-white/20 transition-transform hover:scale-105">
      ...
      {/* Stats Section */}
      <div className="container mx-auto px-4 py-12">
        <div className="backdrop-blur-lg bg-white/30 rounded-3xl shadow-lg border border-white/20 p-8 max-w-4xl mx-auto">
